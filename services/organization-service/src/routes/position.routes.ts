...
import { handleCreatePosition } from '../controllers/position.controllers';
import { validateCreatePosition } from '../middlewares/validationMiddlewares';
...
positionRoutes.post('/', validateCreatePosition, handleCreatePosition);
