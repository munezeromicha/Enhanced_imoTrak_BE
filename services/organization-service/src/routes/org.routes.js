...
const org_controllers_1 = require("../controllers/org.controllers");
const multer_1 = require("../middlewares/multer");
const validationMiddlewares_1 = require("../middlewares/validationMiddlewares");
const organisationRoutes = (0, express_1.Router)();
/**
 * @swagger
 * components:
 *   schemas:
 ...
 */
organisationRoutes.post('/', multer_1.upload.single('organisation_logo'), validationMiddlewares_1.validateCreateOrganization, org_controllers_1.handleCreateOrganization);
/**
 * @swagger
 * /:
 *   get:
 ...
 */
organisationRoutes.get('/', org_controllers_1.handleGetAllOrganizations);
